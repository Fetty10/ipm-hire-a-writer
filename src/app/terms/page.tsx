...
const sections = [
  {
    ...
    body:`iProjectMaster provides custom academic writing assistance to students. All work produced by our writers is original, written specifically for each client based on their instructions, and intended for use as a reference, study guide, or model to support the client's own learning and academic development.

By placing an order on this platform, you confirm that you understand the nature of this service and agree to use the delivered work responsibly and in accordance with your institution's academic policies.`,
  },
  {
    title:"2. Eligibility",
    body:`This service is available to students enrolled at recognised educational institutions worldwide. You must be at least 16 years old to place an order. By registering an account, you confirm that the information you provide — including your name, email address, and contact number — is accurate and belongs to you.`,
  },
  {
    title:"3. Orders and Payment",
    body:`An order is confirmed once payment has been received and verified. For card payments, confirmation is automatic. For bank transfers, confirmation occurs after our team verifies the transfer against your unique reference number.

All prices are displayed in your local currency where supported, or in the currency shown at checkout. Prices are subject to change at any time without prior notice, though changes will not affect orders already confirmed.`,
  },
  {
    title:"4. Delivery and Timelines",
    body:`Chapter delivery timelines depend on your degree level, service type, and current writer workload. Standard turnaround times are communicated during the ordering process. iProjectMaster is not liable for delays caused by circumstances beyond our control.

You will be notified by email and via your dashboard when each chapter is delivered. It is your responsibility to check your account regularly.`,
  },
  {
...
• The chapter was written according to the instructions provided at the time of order
...
We do not offer revisions on the Basic plan. Corrections on other services (seminar, proposal, journal, etc.) are not included unless explicitly stated.`,
  },
  {
    ...
    body:`iProjectMaster treats all client information and project details with strict confidentiality. We do not share, sell, or disclose your personal data or project content to any third party.
...
• A delivered chapter is demonstrably not in line with the instructions provided, and our team is unable to correct it after two revision attempts

Refunds are not offered in the following circumstances:

• You change your mind after an order has been assigned to a writer
• You provided incorrect or insufficient instructions and the work was delivered accordingly
• You have already downloaded the delivered files
• The delay is caused by your failure to respond to queries from our team
...
You may not resell, redistribute, or publish the delivered work as-is for commercial purposes.`,
  },
  {
    ...
    body:`iProjectMaster is not responsible for any academic consequences arising from your use of our services. It is your responsibility to understand your institution's policies on academic assistance and to use our services appropriately.
...
Our total liability to you in any circumstances shall not exceed the amount you paid for the specific order in question.`,
  ...
  {
    title:"12. Contact",
    body:`For questions about these terms, reach us via WhatsApp or through the Contact Us link in our navigation menu.`,
  },
];
