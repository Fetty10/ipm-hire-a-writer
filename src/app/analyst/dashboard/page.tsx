          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
              {[
                ...
                { icon: "⏳", val: pending.length,   label: "Pending Jobs", href: "/analyst/jobs/pending"  },
                { icon: "✍️", val: active.length,    label: "Active Jobs",  href: "/analyst/jobs/active"   },
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div
                ...
                onClick={() => router.push("/analyst/earnings")}
              >
                ...
                {active.length === 0 ? (
                  ...
                  <div className="flex flex-col gap-2">
                    {active.slice(0, 3).map((job) => (
                      <div
                        key={job.id}
                        onClick={() => router.push("/analyst/jobs/active")}
