...
export default function WriterProfile() {
  ...
  if(loading) return <StaffLayout navItems={NAV} role="Analyst" initials={initials}><div style={{textAlign:"center",padding:"3rem",color:"#5B7EA6"}}>Loading...</div></StaffLayout>;
