...
const C = {
  ...
  forgot: { textAlign:"right" as const, marginBottom:"1rem", marginTop:"-.5rem" },
  flink:  { background:"none", border:"none", color:"#38BDF8", fontSize:".75rem", fontWeight:600, cursor:"pointer" },
  ...
  flink2: { background:"none", border:"none", color:"#38BDF8", fontWeight:700, cursor:"pointer", fontSize:".82rem" },
        ...
        <div style={C.card}>
          <form onSubmit={handleSubmit}>
            <div style={C.fg}>
              ...
              <input style={C.inp} type="email" value={email} onChange={e=>setEmail(e.target.value)} required placeholder="your@email.com" />
            </div>
            <div style={C.fg}>
            ...
            <div style={C.forgot}>
              <button type="button" style={C.flink} onClick={()=>router.push("/forgot-password")}>Forgot password?</button>
            </div>
          ...
          <div style={C.foot}>
            <p style={{fontSize:".82rem", color:"#5B7EA6"}}>
              ...
              <button style={C.flink2} onClick={()=>router.push("/staff/apply")}>Apply here</button>
            </p>
          </div>
        </div>
